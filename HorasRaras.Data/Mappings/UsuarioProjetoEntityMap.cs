...
public class UsuarioProjetoEntityMap : IEntityTypeConfiguration<UsuarioProjetoEntity>
{
    public void Configure(EntityTypeBuilder<UsuarioProjetoEntity> builder)
    {

        builder.HasKey(x => new { x.UsuarioId, x.ProjetoId });  
        builder.HasOne(x => x.Usuario)
                .WithMany(x => x.UsuariosProjeto)
    ...
    // DISCUTIR O QUE VAI SER NECESSÁRIO DESSAS CONFIGURAÇÕES
        ...
        // builder.ToTable("usuarioProjetos");
    }
}